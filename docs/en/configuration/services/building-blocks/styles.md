...
| --- | --- | --- | ---
|Styles |`/{apiId}/styles` and `/{apiId}/collections/{collectionId}/styles` |GET<br>POST |HTML, JSON<br>Mapbox Style, OGC SLD 1.0, OGC SLD 1.1
|Style |`/{apiId}/styles/{styleId}` and `/{apiId}/collections/{collectionId}/styles/{styleId}` |GET<br>PUT<br>DELETE |HTML, Mapbox Style, OGC SLD 1.0, OGC SLD 1.1<br>Mapbox Style, OGC SLD 1.0, OGC SLD 1.1<br>n/a
|Style metadata |`/{apiId}/styles/{styleId}/metadata` and `/{apiId}/collections/{collectionId}/styles/{styleId}/metadata` |GET<br>PUT, PATCH |HTML, JSON<br>JSON
