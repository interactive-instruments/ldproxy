 ...
 *     is supported.
 *     <p>In the current version, this provider is only supported in the [Map Tiles]() module. Only
 *     bitmap tile formats are supported. Seeding or caching are not supported.
 ...
 *     <p>In der aktuellen Version wird dieser Provider nur im Modul [Map Tiles]() unterstützt.
 *     Unterstützt werden nur die Bitmap-Kachelformate. Seeding oder Caching werden nicht
 *     unterstützt.
