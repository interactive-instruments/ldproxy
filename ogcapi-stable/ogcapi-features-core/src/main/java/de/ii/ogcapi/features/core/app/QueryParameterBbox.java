...
/**
 * @langEn Only features that have a geometry that intersects the bounding box are selected.
 ...
 * @langDe Es werden nur Features ausgewählt, deren Geometrie den Begrenzungsrahmen schneidet.
 *  Der Begrenzungsrahmen wird als vier Zahlen angegeben:
 *  * Linke untere Ecke, Koordinatenachse 1
 *  * Linke untere Ecke, Koordinatenachse 2
 *  * Rechte obere Ecke, Koordinatenachse 1
 *  * Obere rechte Ecke, Koordinatenachse 2
 * Das Koordinatenreferenzsystem der Werte ist WGS 84 Längen/Breitengrad (http://www.opengis.net/def/crs/OGC/1.3/CRS84)
 * es sei denn, im Parameter `bbox-crs` wird ein anderes Koordinatenreferenzsystem angegeben.
 * Für WGS 84 longitude/latitude sind die Werte in den meisten Fällen die Folge von minimaler Länge,
 * minimaler Breitengrad, maximaler Längengrad und maximaler Breitengrad.
