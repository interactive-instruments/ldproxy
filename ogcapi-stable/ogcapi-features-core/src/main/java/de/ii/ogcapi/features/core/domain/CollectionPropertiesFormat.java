...
public interface CollectionPropertiesFormat extends GenericFormatExtension {
  ...
  String RESOURCE_ID_PATTERN = String.format("(?:%s)", Arrays.stream(CollectionPropertiesType.values())
  ...
  Object getEntity(JsonSchemaObject schemaCollectionProperties, CollectionPropertiesType type, List<Link> links, String collectionId, OgcApi api, ApiRequestContext requestContext);
