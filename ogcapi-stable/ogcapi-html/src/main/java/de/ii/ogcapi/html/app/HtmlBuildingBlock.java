 ...
 * (like [Features](features_html.md)).
 *
 * ## Customization
 *
 * The HTML encoding is implemented using [Mustache templates](https://mustache.github.io/).
 ...
 * die Ausgabeformate bestehen (wie zum Beispiel für [Features](features_html.md))
 * und die Ressource HTML unterstützt, können Clients das Ausgabeformat HTML anfordern.
 *
 * ## Anpassung
 *
 * ldproxy verwendet für die HTML-Ausgabe [Mustache-Templates](https://mustache.github.io/).
 * Anstelle der Standardtemplates von ldproxy können auch benutzerspezifische Templates
 * verwendet werden. Die eigenen Templates müssen als Dateien im ldproxy-Datenverzeichnis
 * unter dem relativen Pfad `templates/html/{templateName}.mustache` liegen, wobei
