...
/**
 * @langEn The dataset is organized in feature collections. This resource provides information about and access to the feature collections.
 *
 * The response contains the list of collections. For each collection, a link to the items in the collection
 * (path `/collections/{collectionId}/items`, link relation `items`) as well as key information about the collection.
 *
 ...
 *
 * * The CRS in which the spatial geometries are stored in the data source (if data is requested in this CRS,
 * the geometries are returned without any coordinate conversion);
 *
