 ...
 * @lang_en The module *Feature Collections* has to be enabled for every API with a feature provider.
 ...
 * mentioned resources.
 * @lang_de Das Modul "Feature Collections" ist für jede über ldproxy bereitgestellte API mit einem
