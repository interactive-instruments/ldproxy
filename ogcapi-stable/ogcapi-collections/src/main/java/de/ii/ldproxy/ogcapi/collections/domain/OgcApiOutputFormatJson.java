 ...
 */
@Component
@Provides(specifications = {OgcApiOutputFormatJson.class, CollectionsFormatExtension.class, FormatExtension.class, OgcApiExtension.class})
@Instantiate
public class OgcApiOutputFormatJson implements CollectionsFormatExtension {
