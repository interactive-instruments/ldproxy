...
/**
 * @title `defaultExtent`
 * @en Default value for spatial (`spatial`) and/or temporal (`temporal`) extent for
 ...
 * @de Es kann ein Standardwert für die räumliche (`spatial`) und/oder zeitliche (`temporal`)
