 ...
 * # Resource paths
 *
 * @langEn ll resource paths in this documentation are relative to the base URI of the deployment.
 ...
 * @langDe Alle Pfadangaben in dieser Dokumentation sind relativ zur Basis-URI des Deployments. Ist
...
/**
 * A resource is any path/URI supported by the API. Through path parameters any instance may
 * represent multiple resources of the API.
 */
