...
/**
 * # `metadata`
 * @langEn General metadata for the API (version, contact details, license information).
 ...
 * (*HTML Landing Page*), `licenseName` (*API Definition*, *HTML Landing Page*,
 * *Feature Collections*, *Feature Collection*), `licenseUrl` (*API Definition*,
 ...
 * `contactName` (API-Definition, HTML-Landing-Page), `contactUrl` (API-Definition,
 * HTML-Landing-Page), `contactEmail` (API-Definition, HTML-Landing-Page), `contactPhone`
 * (HTML-Landing-Page), `licenseName` (API-Definition, HTML-Landing-Page, Feature-Collections,
 * Feature-Collection), `licenseUrl` (API-Definition, HTML-Landing-Page, Feature-Collections,
 * Feature-Collection),  `keywords` (Meta-Tags und schema:Dataset in HTML-Landing-Page),
 * `attribution` (Landing-Page, Karten), `creatorName` (schema:Dataset in HTML), `creatorUrl`
 * (schema:Dataset in HTML), `creatorLogoUrl` (schema:Dataset in HTML), `publisherName`
 * (schema:Dataset in HTML), `publisherUrl` (schema:Dataset in HTML), `publisherLogoUrl`
 * (schema:Dataset in HTML). Alle Angaben sind Strings, bis auf die Keywords, die als Array
 * von Strings angegeben werden.
 * @default `{}`
 */
@Value.Immutable
