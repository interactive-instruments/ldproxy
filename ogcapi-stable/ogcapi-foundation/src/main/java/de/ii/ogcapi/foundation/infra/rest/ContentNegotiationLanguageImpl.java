...
public class ContentNegotiationLanguageImpl implements ContentNegotiationLanguage {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ContentNegotiationLanguageImpl.class);
    ...
    @Override
    public Optional<Locale> negotiateLanguage(Request request, HttpHeaders httpHeaders, UriInfo uriInfo) {
    ...
    private void evaluateLanguageParameter(
        ...
        if (queryParameters.containsKey(LANGUAGE_PARAMETER)) {
            ...
            Optional<Locale> ogcApiLocale = I18n.getLanguages().stream()
                    ...
                    .findFirst();
            ogcApiLocale.ifPresent(value -> headers.putSingle(ACCEPT_LANGUAGE_HEADER, value
                .getLanguage()));
        }
    }
