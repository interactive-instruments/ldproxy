...
/**
 * @title HTTP header for caching
 * @en ldproxy sets the following HTTP headers for HTTP caching in responses - as far as they can
 ...
 * @de ldproxy setzt in Antworten die folgenden HTTP-Header für HTTP-Caching - soweit diese für die jeweilige
