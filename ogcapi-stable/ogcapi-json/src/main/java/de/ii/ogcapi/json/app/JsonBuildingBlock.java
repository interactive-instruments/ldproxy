 ...
 * supported resource that does not have more specific rules (like [Features](geo_json.md)).
 ...
 * Ausgabeformate bestehen (wie zum Beispiel für [Features](geo_json.md)) und die Ressource
