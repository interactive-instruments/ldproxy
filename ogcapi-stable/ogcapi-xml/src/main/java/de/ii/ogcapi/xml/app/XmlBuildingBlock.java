...
/**
 * @title XML (XML)
 * @en The module *XML* may be enabled for every API with a feature provider.
 ...
 * @de Das Modul "XML" kann für jede über ldproxy bereitgestellte API aktiviert werden. Es ist
