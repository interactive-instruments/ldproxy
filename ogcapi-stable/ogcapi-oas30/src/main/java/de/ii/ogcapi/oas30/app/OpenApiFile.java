...
@Singleton
@AutoBind
public class OpenApiFile implements ApiDefinitionAuxiliaryFormatExtension {
  ...
  @Override
  public Response getFile(OgcApiDataV2 apiData, ApiRequestContext apiRequestContext, String file) {
