...
public interface GenericFormatExtension extends FormatExtension {
  ...
  Map<String, Class<? extends ExtensionConfiguration>> FORMAT_MAP =
      ImmutableMap.of(
          "HTML", HtmlConfiguration.class,
          "JSON", JsonConfiguration.class,
          "XML", XmlConfiguration.class);

  /**
   * By default, encodings with the labels that are enabled in Common Core are enabled. These
   * defaults should be overloaded for specific resources like features or stylesheets.
   *
