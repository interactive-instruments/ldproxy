...
public class JsonGeneratorDebug extends JsonGenerator {
    ...
    @Override
    public void writeRawValue(String string, int i, int i1) throws IOException, JsonGenerationException {
        LOGGER.debug(string.substring(i, i1));
    ...
    @Override
    public int writeBinary(Base64Variant bv, InputStream in, int i) throws IOException, JsonGenerationException {
    ...
    @Override
    public void writeStringField(String string, String string1) throws IOException, JsonGenerationException {
