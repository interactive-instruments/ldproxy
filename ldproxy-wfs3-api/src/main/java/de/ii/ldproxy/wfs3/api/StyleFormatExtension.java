 ...
 */
public interface StyleFormatExtension extends Wfs3Extension {

    default boolean isEnabledForService(Wfs3ServiceData serviceData) {
        return true;
    }
     ...
     */
    String getTitle(Wfs3ServiceData serviceData, String styleId);
     ...
     * @return the response with the style
     */
    public Response getStyle(Wfs3ServiceData serviceData, String styleId);
};
