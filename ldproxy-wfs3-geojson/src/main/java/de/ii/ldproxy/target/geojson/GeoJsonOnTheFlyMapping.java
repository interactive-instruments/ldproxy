...
public class GeoJsonOnTheFlyMapping implements WfsProxyOnTheFlyMapping {
    ...
    public TargetMapping getTargetMappingForGeometry(XMLPathTracker path, String nsuri, String localName) {
        GeoJsonGeometryMapping.GEO_JSON_GEOMETRY_TYPE geoType = GeoJsonGeometryMapping.GEO_JSON_GEOMETRY_TYPE.forGmlType(GML_GEOMETRY_TYPE.fromString(localName).toSimpleFeatureGeometry());
