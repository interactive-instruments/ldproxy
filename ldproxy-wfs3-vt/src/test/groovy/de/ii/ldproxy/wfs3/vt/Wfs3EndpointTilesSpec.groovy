...
import de.ii.ldproxy.wfs3.vt.TilesConfiguration.Tiles.MinMax
...
class Wfs3EndpointTilesSpec extends Specification {
    ...
    def 'Check tiles support enabled in dataset with no enabled map'(){
        ...
        Wfs3EndpointTiles.checkTilesParameterDataset(enabledMap)
    ...
    def 'Check tiles support enabled in dataset'(){
        ...
        def result = Wfs3EndpointTiles.checkTilesParameterDataset(enabledMap)
    ...
    def 'get all Collection ids multiple tests with data table'(boolean mvtEnabled,boolean onlyJson, boolean startSeeding,Set<String>allCollectionIds,Map<String,Boolean> enabledMap,Map<String,List<String>> formatsMap,Map<String,Map<String,MinMax>> seedingMap, HashSet<String> result){
        ...
        expect: Wfs3EndpointTiles.getCollectionIdsDataset(allCollectionIds,enabledMap,formatsMap,seedingMap,mvtEnabled,onlyJson,startSeeding)==result
      ...
      /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        ...
        false      | false    | false        | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",true))   | null                                                                                                   | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || new HashSet<>()
        false      | false    | false        | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",true))   | new HashMap(ImmutableMap.of("unknownCollection", ImmutableList.of("application/json")))            | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || new HashSet<>()
        false      | false    | false        | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",false))  | new HashMap(ImmutableMap.of("collection", ImmutableList.of("application/json")))                   | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || new HashSet<>()
        false      | false    | false        | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",true))   | new HashMap(ImmutableMap.of("collection", ImmutableList.of("application/json")))                   | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || allCollectionIds
        ...
        false      | false    | true         | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",true))   | new HashMap(ImmutableMap.of("collection", ImmutableList.of("application/json")))                   | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || allCollectionIds
        false      | true     | false        | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",true))   | new HashMap(ImmutableMap.of("collection", ImmutableList.of("application/vnd.mapbox-vector-tile"))) | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || new HashSet<>()
        false      | true     | false        | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",true))   | new HashMap(ImmutableMap.of("collection", ImmutableList.of("application/json")))                   | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || allCollectionIds
        true       | false    | false        | new HashSet(Arrays.asList("collection")) | new HashMap(ImmutableMap.of("collection",true))   | new HashMap(ImmutableMap.of("collection", ImmutableList.of("application/json")))                   | new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))  || new HashSet<>()
    ...
    def 'get all Collection ids with tiles parameter enabled - tiles support enabled in one collection' (){
        ...
        def seedingMap = new HashMap(ImmutableMap.of(
                "collection0", ImmutableMap.of("default", ImmutableMinMax.builder().max(10).min(6).build()),
                "collection1", ImmutableMap.of("default", ImmutableMinMax.builder().max(10).min(6).build()),
                "collection2", ImmutableMap.of("default", ImmutableMinMax.builder().max(10).min(6).build()),
                "collection3", ImmutableMap.of("default", ImmutableMinMax.builder().max(10).min(6).build())))
        ...
        def result = Wfs3EndpointTiles.getCollectionIdsDataset(allCollectionIds,enabledMap,formatsMap,seedingMap,mvtEnabled,onlyJson,startSeeding)
    ...
    def 'get all Collection ids with seeding parameter enabled - seeding parameter enabled in one collection' (){
        ...
        seedingMap.put("collection1", ImmutableMap.of("default", ImmutableMinMax.builder().max(10).min(6).build()))
    ...
    def 'get all Collection ids with tiles parameter enabled - one of the three input Maps is not initialized' (){
        ...
        def formatsMap = null
        def seedingMap = new HashMap(ImmutableMap.of("collection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))
        def mvtEnabled = false
        def onlyJson = false
        def startSeeding = false
    ...
    def 'get all Collection ids with tiles parameter enabled - one of the three input Maps does not contain the collection' (){
        ...
        def seedingMap = new HashMap(ImmutableMap.of("unknownCollection", ImmutableMap.of("default",ImmutableMinMax.builder().max(10).min(6).build())))
        def mvtEnabled = false
        def onlyJson = false
        def startSeeding = false
