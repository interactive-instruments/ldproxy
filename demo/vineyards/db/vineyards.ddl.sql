...
--
-- Name: vineyards_ogc_fid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.vineyards_ogc_fid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.vineyards_ogc_fid_seq OWNER TO postgres;

--
-- Name: vineyards_ogc_fid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.vineyards_ogc_fid_seq OWNED BY public.vineyards.ogc_fid;
...
ALTER TABLE ONLY public.vineyards ALTER COLUMN ogc_fid SET DEFAULT nextval('public.vineyards_ogc_fid_seq'::regclass);
...
ALTER TABLE ONLY public.vineyards
    ADD CONSTRAINT vineyards_pkey PRIMARY KEY (ogc_fid);


--
-- Name: vineyards_wkb_geometry_geom_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX vineyards_wkb_geometry_geom_idx ON public.vineyards USING gist (wkb_geometry);
