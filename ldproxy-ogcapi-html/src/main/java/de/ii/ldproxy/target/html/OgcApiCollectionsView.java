...
public class OgcApiCollectionsView extends LdproxyView {
    ...
    public OgcApiCollectionsView(OgcApiDatasetData apiData, Collections collections,
        ...
        super("collections.mustache", Charsets.UTF_8, apiData, breadCrumbs, htmlConfig, urlPrefix,
        ...
        if (apiData.getFeatureProvider()
                       .getDataSourceUrl()
                       .isPresent()) {
            this.dataSourceUrl = apiData.getFeatureProvider()
                                            .getDataSourceUrl()
                                            .get();
        }
