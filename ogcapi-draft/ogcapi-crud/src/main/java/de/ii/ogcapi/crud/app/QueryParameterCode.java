...
@Singleton
@AutoBind
public class QueryParameterCode extends ApiExtensionCache implements OgcApiQueryParameter {

  private Schema<?> schema = null;
  private final SchemaValidator schemaValidator;

  @Inject
  public QueryParameterCode(SchemaValidator schemaValidator) {
        ...
        () ->
            isEnabledForApi(apiData)
                ...
                && (definitionPath.equals("/collections/{collectionId}/callback")
                    || definitionPath.equals("/collections/{collectionId}/crud")));
  }
