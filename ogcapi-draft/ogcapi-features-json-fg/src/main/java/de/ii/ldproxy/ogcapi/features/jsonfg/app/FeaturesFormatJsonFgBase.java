...
public abstract class FeaturesFormatJsonFgBase implements FeatureFormatExtension {
    ...
    protected final GeoJsonWriterRegistry geoJsonWriterRegistry;
    protected final CrsTransformerFactory crsTransformerFactory;

    public FeaturesFormatJsonFgBase(@Requires SchemaGeneratorOpenApi schemaGeneratorFeature,
    ...
    protected abstract boolean includePrimaryGeometry(FeatureTransformationContext transformationContext);
