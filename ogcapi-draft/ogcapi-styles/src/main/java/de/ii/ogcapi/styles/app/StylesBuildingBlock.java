...
/**
 * @title
 * @en Adds support for publishing and managing styles (*Mapbox Style* or *SLD*) and related
 ...
 * @de Das Modul "Styles" kann für jede über ldproxy bereitgestellte API aktiviert werden.
