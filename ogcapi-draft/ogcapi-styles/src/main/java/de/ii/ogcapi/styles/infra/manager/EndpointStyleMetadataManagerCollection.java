 ...
 * @path collection/{collectionId}/styles/{styleId}/metadata
 * @langEn Update style metadata of style for a feature collection.
 * @langDe Aktualisieren der Metadaten eines Styles für eine Feature Collection.
