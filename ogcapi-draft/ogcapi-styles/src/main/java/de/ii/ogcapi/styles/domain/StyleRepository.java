...
public interface StyleRepository {
   ...
   */
  Stream<StylesFormatExtension> getStylesFormatStream(
   ...
   */
  Stream<StyleFormatExtension> getStyleFormatStream(
      OgcApiDataV2 apiData, Optional<String> collectionId);
   ...
   */
  Stream<StyleMetadataFormatExtension> getStyleMetadataFormatStream(
      OgcApiDataV2 apiData, Optional<String> collectionId);
   ...
   * @param includeDerived include also derived collection styles, only effective, if collectionId
   *     is present
   * @param includeHtml include the derived HTML web map in the list
   * @return list of style encodings for this style
   */
  List<ApiMediaType> getStylesheetMediaTypes(
  ...
  /**
   * determine date of last change to any stylesheet of the style; this includes root stylesheets
   * from which a collection stylesheet will be derived
   *
   * @param apiData information about the API
   * @param collectionId the optional collection, or empty for a style collection at root level
   * @param styleId the identifier of the style in the style collection
   ...
   * @return the date or {@code null}, if no stylesheet is found
   */
  Date getStylesheetLastModified(
      OgcApiDataV2 apiData,
      Optional<String> collectionId,
      String styleId,
      StyleFormatExtension styleFormat,
   ...
   */
  StylesheetContent getStylesheet(
      OgcApiDataV2 apiData,
      Optional<String> collectionId,
      String styleId,
      StyleFormatExtension styleFormat,
   ...
   */
  StyleMetadata getStyleMetadata(
      OgcApiDataV2 apiData,
      Optional<String> collectionId,
      String styleId,
      ApiRequestContext requestContext);
  ...
  void deleteStyle(OgcApiDataV2 apiData, Optional<String> collectionId, String styleId)
      throws IOException;

  void writeStyleMetadataDocument(
