...
public class CityJsonWriterId implements CityJsonWriter {
    ...
    public void onValue(EncodingAwareContextCityJson context,
        ...
        if (context.getState().inSection()==FeatureTransformationContextCityJson.StateCityJson.Section.IN_BUILDING
            ...
            } else if (context.getState().inBuildingPart() && CityJsonWriter.ID.equals(schema.getName())) {
                //noinspection ConstantConditions
