 ...
 *
 * The module requires that the feature provider includes a type `building` that is mapped to a
 ...
 *
 * Das Modul erfordert, dass der Feature-Provider einen Typ `building` enthält, der auf ein CityJSON-Building-Feature
 ...
 *
 * @propertyTable {@link de.ii.ogcapi.features.cityjson.domain.CityJsonConfiguration}
 */
@Singleton
@AutoBind
