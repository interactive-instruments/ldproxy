...
public abstract class WaypointsValue {
    ...
    @Value.Check
    void check() {
        Preconditions.checkState(getType().equals("MultiPoint"), "WaypointsValue is not a MultiPoint geometry. Found: {}.", getType());
    ...
    public static final Funnel<WaypointsValue> FUNNEL = (from, into) -> {
