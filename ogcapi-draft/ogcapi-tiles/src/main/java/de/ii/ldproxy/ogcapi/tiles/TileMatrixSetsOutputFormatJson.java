...
@Provides
@Instantiate
public class TileMatrixSetsOutputFormatJson implements TileMatrixSetsFormatExtension {

    @Requires
    SchemaGenerator schemaGenerator;

    private final Schema schemaTileMatrixSets;
    public final static String SCHEMA_REF_TILE_MATRIX_SETS = "#/components/schemas/TileMatrixSets";
    private final Schema schemaTileMatrixSet;
    public final static String SCHEMA_REF_TILE_MATRIX_SET = "#/components/schemas/TileMatrixSet";

    public TileMatrixSetsOutputFormatJson() {
        schemaTileMatrixSets = schemaGenerator.getSchema(TileMatrixSets.class);
        schemaTileMatrixSet = schemaGenerator.getSchema(TileMatrixSet.class);
    }
