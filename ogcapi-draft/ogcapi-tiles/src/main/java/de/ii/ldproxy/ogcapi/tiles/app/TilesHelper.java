...
public class TilesHelper {
    ...
    public static TileSet buildTileSet(OgcApiDataV2 apiData,
        ...
        try {
            BoundingBox boundingBox = (collectionId.isPresent() ? metadataRegistry.getSpatialExtent(apiData.getId(),collectionId.get()) : metadataRegistry.getSpatialExtent(apiData.getId()))
