...
import de.ii.ogcapi.tiles.domain.tileMatrixSet.ImmutableQueryInputTileMatrixSet;
import de.ii.ogcapi.tiles.domain.tileMatrixSet.ImmutableQueryInputTileMatrixSets;
...
/**
 * @langEn Returns the definition of the tiling scheme according to the [OGC Two Dimensional
 * Tile Matrix Set standard](http://docs.opengeospatial.org/is/17-083r2/17-083r2.html).
 * @langDe TODO
