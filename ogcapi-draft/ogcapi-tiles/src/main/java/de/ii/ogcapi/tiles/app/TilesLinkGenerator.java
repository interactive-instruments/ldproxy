...
public class TilesLinkGenerator extends DefaultLinksGenerator {
     ...
     */
    public List<Link> generateLandingPageLinks(URICustomizer uriBuilder, DataType dataType, I18n i18n, Optional<Locale> language) {
     ...
     * @return a list with links
     */
    public List<Link> generateCollectionLinks(URICustomizer uriBuilder, DataType dataType, I18n i18n, Optional<Locale> language) {
