...
public interface StaticTileProviderStore extends ApiExtension {
   ...
   */
  Optional<Integer> getMinzoom(OgcApiDataV2 apiData, String filename)
   ...
   */
  Optional<Integer> getMaxzoom(OgcApiDataV2 apiData, String filename)
      throws SQLException, IOException;
   ...
   */
  Optional<Integer> getDefaultzoom(OgcApiDataV2 apiData, String filename)
      throws SQLException, IOException;
