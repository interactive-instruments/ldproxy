...
@Provides
@Instantiate
public class EndpointMapTilesTileSetMultiCollection extends Endpoint {

    private final TilesQueriesHandler queryHandler;

    EndpointMapTilesTileSetMultiCollection(@Requires ExtensionRegistry extensionRegistry,
