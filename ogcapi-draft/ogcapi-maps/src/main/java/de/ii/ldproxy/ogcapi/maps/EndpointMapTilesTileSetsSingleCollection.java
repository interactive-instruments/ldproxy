...
/**
 * Handle responses under '/collections/{collectionId}/map/tiles'.
 */
@Component
@Provides
@Instantiate
public class EndpointMapTilesTileSetsSingleCollection extends Endpoint {

    private final TilesQueriesHandler queryHandler;

    EndpointMapTilesTileSetsSingleCollection(@Requires ExtensionRegistry extensionRegistry,
    ...
    public Response getTileSets(@Context OgcApi api, @Context ApiRequestContext requestContext,
        ...
        checkPathParameter(extensionRegistry, apiData, "/collections/{collectionId}/map/tiles", "collectionId", collectionId);
