...
import static de.ii.ldproxy.ogcapi.foundation.domain.ApiEndpointDefinition.SORT_PRIORITY_FEATURES;
...
import de.ii.ldproxy.ogcapi.foundation.domain.ImmutableApiEndpointDefinition.Builder;
