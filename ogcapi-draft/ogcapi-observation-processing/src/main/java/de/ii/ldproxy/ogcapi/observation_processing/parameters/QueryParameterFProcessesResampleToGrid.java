...
@Provides
@Instantiate
public class QueryParameterFProcessesResampleToGrid extends QueryParameterF {

    @Requires
    FeatureProcessInfo featureProcessInfo;

    protected QueryParameterFProcessesResampleToGrid(@Requires OgcApiExtensionRegistry extensionRegistry) {
